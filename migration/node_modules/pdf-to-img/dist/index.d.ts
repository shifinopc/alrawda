...
export interface Pdf extends AsyncDisposable, AsyncIterable<Buffer, void, void> {
    length: number;
 ...
 * ```
 */
export declare function pdf(input: string | Uint8Array | Buffer | NodeJS.ReadableStream, options?: Options): Promise<Pdf>;
